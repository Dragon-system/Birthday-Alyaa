...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const arabicMessage = `منذ ما يقارب ست سنوات علي تعرفي على أجمل شخص في الكون، وأصبحتِ منذ هذا الوقت شريكة حياتي وتفاصيل أيامي الجميلة.

واليوم نحتفل بعيد ميلادك السابع عشر(17) وعيد ميلادك السادس معي وأنتِ ما زلتِ أجمل هدية رزقني الله بها.
...
أسأل الله أن يديم عليكِ الصحة والعافية، وأن يجعل كل أيامكِ فرحًا وسعادة، وأن نبقى معًا في كل وقت سعاده وحزن فرح وبكاء دوما معي .

 لا استطيع الوصف لك كيف اشعر عندما اري او اتخيل مشهد رؤيتك وانتي تكبرين عام بعد عام لم تصبحي تلك الطفله المدلله
 
 ❤️لاكنك اصبحتي الان عروسا مدلله وجميله.

❤️ اطلع لروئية انجازات حياتك يحلوتي.
